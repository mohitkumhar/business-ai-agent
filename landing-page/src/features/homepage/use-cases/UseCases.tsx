...
const useCases = [
  {
    ...
    images: {
      builder: {
        ...
        alt: "An example of a bot being built in ProfitPilot",
      },
      bot: {
        src: marketingBotSrc,
  ...
  },
  {
    ...
    images: {
      builder: {
        src: salesBuilderSrc,
        alt: "An example of a sales bot being built in ProfitPilot",
      },
      bot: {
        src: salesBotSrc,
  ...
  <div className="flex flex-col gap-6 items-center">
    <p className="text-balance max-w-4xl md:text-center text-lg">
      ...
      <span className="font-medium">
        an AI partner that thinks like a business owner
      </span>
      : it connects your scattered data, monitors your financial health, and validates your decisions in real-time. Instead of relying on guesswork or emotion,{" "}
      <span className="font-medium">
        it's time to run your business with clarity, safety, and total confidence
      </span>
      .
    </p>
