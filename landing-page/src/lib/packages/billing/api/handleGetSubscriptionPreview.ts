...
export const getSubscriptionPreviewInputSchema = z.object({
  workspaceId: z.string(),
  plan: z.enum([Plan.STARTER, Plan.PRO]),
});

export const handleGetSubscriptionPreview = async ({
  input,
  context,
}: {
  input: z.infer<typeof getSubscriptionPreviewInputSchema>;
  context: {
