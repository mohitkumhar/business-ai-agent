import { templateUpdatedAt } from "./templates.constants";
...
export const templateDefinitions: TemplateDefinition[] = [
  {
    ...
    highlights: [
      { title: "Goal", description: "Turn visitors into qualified leads." },
      { title: "Flow", description: "Warm welcome, quick questions, then contact details." },
      { title: "Result", description: "Cleaner lead data for faster follow up." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Reduce support load while helping users faster." },
      { title: "Flow", description: "Pick a topic, get a clear answer, then escalate if needed." },
      { title: "Result", description: "Fewer tickets and happier customers." },
    ],
  ...
  },
  {
    ...
    useCase: "Quiz & Survey",
    features: [],
    summary: "A quiz chatbot template that asks fun questions and shows a clear result.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Engage visitors with a short, friendly quiz." },
      { title: "Flow", description: "One question at a time, then a result page." },
      { title: "Result", description: "Higher completion rates and clear outcomes." },
    ],
  ...
  },
  {
    ...
    useCase: "Lead Generation",
    features: [],
    summary: "A lead scoring chatbot template that qualifies prospects with a simple score.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Score leads so sales can focus on the best fits." },
      { title: "Flow", description: "Short qualification questions, then a clear score." },
      { title: "Result", description: "Better prioritization and faster response time." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Grow your list with a useful asset." },
      { title: "Flow", description: "Offer value, collect email, deliver the file." },
      { title: "Result", description: "More signups with clear intent data." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Guide shoppers to the best product faster." },
      { title: "Flow", description: "Ask preferences, then recommend a match." },
      { title: "Result", description: "Higher conversion and fewer drop offs." },
    ],
  ...
  },
  {
    ...
    useCase: "Quiz & Survey",
    features: [],
    summary: "An NPS survey chatbot template that measures loyalty in under a minute.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Measure loyalty with a quick NPS flow." },
      { title: "Flow", description: "Score first, then ask for a short reason." },
      { title: "Result", description: "Clear feedback you can act on fast." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Help new users reach their first win." },
      { title: "Flow", description: "Short checklist, links, and progress prompts." },
      { title: "Result", description: "Better activation and lower churn." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Convert interest into a paid download." },
      { title: "Flow", description: "Pitch, collect email, then take payment." },
      { title: "Result", description: "A fast checkout that feels personal." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Answer common questions in seconds." },
      { title: "Flow", description: "Choose a topic, read a clear answer, then continue." },
      { title: "Result", description: "Less support load and faster help." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Deliver a fun, fast recommendation." },
      { title: "Flow", description: "Collect preferences, then suggest a pick." },
      { title: "Result", description: "A playful experience users can share." },
    ],
  ...
  },
  {
    ...
    useCase: "AI Chat",
    features: ["AI-powered"],
    summary: "A basic AI chatbot template for open ended questions and quick answers.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Launch a fast, flexible AI chat experience." },
      { title: "Flow", description: "User asks, AI responds, repeat." },
      { title: "Result", description: "A clean baseline you can extend." },
    ],
  ...
  },
  {
    ...
    summary: "An audio AI chatbot template that lets users talk and hear replies.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Make AI chat work with voice." },
      { title: "Flow", description: "Record audio, upload, then hear a reply." },
      { title: "Result", description: "A friendly voice experience that feels modern." },
    ],
  ...
  },
  {
    ...
    useCase: "AI Chat",
    features: ["AI-powered"],
    summary: "An AI persona chatbot template that lets users pick a personality.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Show how AI tone can change by role." },
      { title: "Flow", description: "Pick a persona, then start the chat." },
      { title: "Result", description: "A playful, memorable AI demo." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Collect leads with more useful context." },
      { title: "Flow", description: "Short questions with AI follow ups." },
      { title: "Result", description: "Higher quality leads and cleaner handoff." },
    ],
  ...
  },
  {
    ...
    useCase: "E-commerce",
    features: [],
    summary: "An insurance offer chatbot template that matches users to the right plan.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Guide users to the right coverage option." },
      { title: "Flow", description: "Ask key details, then present an offer." },
      { title: "Result", description: "More qualified quote requests." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Route users based on what they ask." },
      { title: "Flow", description: "Capture intent, then send to the right branch." },
      { title: "Result", description: "Smarter flows with less manual logic." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Focus on high fit prospects." },
      { title: "Flow", description: "Ask budget, needs, and decision timing." },
      { title: "Result", description: "Better qualification with fewer calls." },
    ],
  ...
  },
  {
    ...
    useCase: "Entertainment",
    features: [],
    summary: "A carb calculator chatbot template that gives quick fueling guidance.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Give a quick, useful calculation." },
      { title: "Flow", description: "Collect basics, then share the estimate." },
      { title: "Result", description: "A helpful tool users can finish fast." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Match users to the right routine." },
      { title: "Flow", description: "Ask skin questions, then recommend products." },
      { title: "Result", description: "More confident shoppers and higher intent." },
    ],
  ...
  },
  {
    ...
    useCase: "AI Chat",
    features: ["AI-powered"],
    summary: "An OpenAI assistant chatbot template for task focused AI conversations.",
    description:
    ...
    highlights: [
      { title: "Goal", description: "Build a focused AI helper fast." },
      { title: "Flow", description: "User asks, assistant replies with a task first answer." },
      { title: "Result", description: "A clean base for AI workflows." },
    ],
  ...
  },
  {
    ...
    highlights: [
      { title: "Goal", description: "Show value with a quick estimate." },
      { title: "Flow", description: "Collect usage data, then show savings." },
      { title: "Result", description: "Stronger value perception and intent." },
    ],
