        ...
        <div className="w-full p-10 md:p-14 rounded-[3.5rem] bg-black/60 border border-white/10 backdrop-blur-3xl shadow-[0_32px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group">
          ...
          <div className="relative z-10 w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {mode === "signup" && (
                <>
                  <div className="space-y-2">
                    abel className="text-[11px] font-bold uppercase tracking-widest text-white/40 ml-2">Full Name</label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="space-y-2">
                    abel className="text-[11px] font-bold uppercase tracking-widest text-white/40 ml-2">Business Name</label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="space-y-2">
                    abel className="text-[11px] font-bold uppercase tracking-widest text-white/40 ml-2">Phone / WhatsApp</label>
                    <input
                      required
                      type="tel"
              ...
              <div className="space-y-2">
                abel className="text-[11px] font-bold uppercase tracking-widest text-white/40 ml-2">Work Email</label>
                <input
                  required
                  type="email"
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  abel className="text-[11px] font-bold uppercase tracking-widest text-white/40 ml-1">Password</label>
