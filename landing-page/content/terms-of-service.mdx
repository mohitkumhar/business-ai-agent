...
You are responsible for maintaining the security of your account and password. ProfitPilot cannot and will not be liable for any loss or damage from your failure to comply with this security obligation.
...
ProfitPilot prohibits content and activities that:
...
We reserve the right to suspend or terminate any account which violates these terms.If you find content or activity that violates these terms, please report it to the project maintainers through the official project repository.
...
You can manage your subscription and account settings through the platform interface when available.

## Refund Policy

We offer a 14-day refund period from your first payment. If you're not satisfied with our service during this period, we'll provide a full refund, no questions asked. To request a refund, please contact the project maintainers through the official support channels within 14 days of your initial payment.
...
You are solely responsible for properly canceling your account. An email to cancel your account is not considered cancellation. Account cancellation options are available through the platform interface when supported. We provide a simple no-questions-asked cancellation link.

If you cancel the service before the end of your current paid up period, your cancellation will take effect at the end of the current billing cycle, and you will not be charged again. All of your workflows, and collected answers will still be accessible, your subscription will be downgraded to the free plan.
...
ProfitPilot shall not be liable to you or to any third-party for any modification, price change, suspension or discontinuance of the service.
...
You own all right, title, and interest to your chatbots data. We do not collect and analyze personal information from chatbots' users and we do not use behavioral insights to sell advertisements. We will never collect or store any personally identifiable information and we will never abuse your user’s privacy. When using ProfitPilot, you 100% own and control all of your workspace data. We will never sell or share your site data to any third-parties.

You agree to comply with all applicable laws including all privacy and data protection regulations.

## Liability

Your use of ProfitPilot is at your sole risk. The service is provided on an “as is” and “as available” basis. We do take uptime of our application seriously.Information about service availability may be communicated through official project communication channels.
...
We as humans can access your data to help you with support requests you make and to maintain and safeguard ProfitPilot to ensure the security of your data and the service as a whole.

We use third party vendors to provide the necessary hardware, storage, payment processing and related technology required to run the Services. Third-party service providers may be used to support operation of the platform where necessary.
...
If you have questions regarding these Terms of Service, please contact the project maintainers through the official project repository.
