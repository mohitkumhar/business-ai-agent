...
If our services access Google user data through Google APIs, such data will be handled in accordance with the Google API Services User Data Policy, including the Limited Use requirements.
