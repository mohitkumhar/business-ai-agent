...
- **ProfitPilot telemetry**: The same `typebot` cookie described above is used to link your anonymous visitor activity to your user account when you sign in.
...
You can ask to delete your ProfitPilot account at any time by [contacting us](mailto:contact@typebot.io). All your data will be permanently deleted immediately.
