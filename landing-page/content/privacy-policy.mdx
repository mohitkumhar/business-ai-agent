...
## When integrations with third-party services are used, we strive to handle data in accordance with applicable provider requirements and policies. For Google integrations, ProfitPilot will adhere to the Google API Services User Data Policy, including applicable Limited Use requirements.
