...
When integrations with third-party services are used, we strive to handle data in accordance with Google API Services User Data Policy requirements, including the Limited Use requirements where applicable.
