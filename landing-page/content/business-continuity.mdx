...
ProfitPilot is released under the [**Functional Source License (FSL)**](https://docs.typebot.io/self-hosting/get-started#license-requirements), a modern, fair-source model designed to balance open access and business sustainability.
...
As the founder, ProfitPilot 
is my full-time, long-term focus. I've been working on it for a long time with no plans to stop. My goal is to build a sustainable, reliable product. Not pursue rapid exits or risky pivots.
...
Baptiste Arnaud,<br />Founder of ProfitPilot 
